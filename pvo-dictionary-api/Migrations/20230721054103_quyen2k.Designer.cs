...
namespace pvo_dictionary_api.Migrations
{
    ...
    [Migration("20230721054103_quyen2k")]
    partial class quyen2k
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pvo_dictionary_api.Models.ConceptSearchHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pvo_dictionary_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_date = new DateTime(2023, 7, 21, 12, 41, 2, 719, DateTimeKind.Local).AddTicks(9375),
                            display_name = "Quyen",
            ...
            modelBuilder.Entity("pvo_dictionary_api.Models.ExampleRelationship", b =>
                {
                    b.HasOne("pvo_dictionary_api.Models.ExampleLink", "ExampleLink")
                        .WithMany()
